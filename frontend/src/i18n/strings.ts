...
export const STRINGS = {
  ...
  'settings.wifi_keepalive_hint': { zh: '開啟後,裝置閒置在虛擬位置時會定期重新發送,避免 iPhone 螢幕變暗後 WiFi tunnel 中斷。會稍微增加耗電。', en: 'When on, an idle virtual location is periodically re-sent so the Wi-Fi tunnel survives the iPhone screen dimming. Uses a little more battery.' },
  ...
  'device.unpaired_label': { zh: '未配對 · 點「連線」配對', en: 'Not paired · tap Connect' },
