...
export const STRINGS = {
  ...
  'status.restore_tooltip': { zh: '清除 iPhone 上的虛擬定位,還原為真實 GPS', en: 'Clear the virtual location on the iPhone and restore real GPS' },
  ...
  'status.set_initial_tooltip': { zh: '設定地圖預設檢視中心,只影響啟動時顯示位置,不會改變 iPhone 虛擬 GPS', en: 'Set the default map viewport only. Does NOT change the iPhone\'s virtual GPS.' },
  ...
  'locate.fly_only': { zh: '只飛畫面,不定位', en: 'Fly map only' },
  'locate.fly_only_hint': { zh: '移動畫面,不動虛擬 GPS', en: 'Pan map; don\'t touch virtual GPS' },
  'locate.fly_and_teleport': { zh: '飛過去 + 定位', en: 'Fly & teleport' },
  'locate.fly_and_teleport_hint': { zh: '傳送虛擬 GPS 到此位置', en: 'Teleport virtual GPS here' },
  ...
  'panel.route_category_rename': { zh: '重新命名分類', en: 'Rename category' },
  ...
  'bm.select_mode': { zh: '進入多選模式,可一次刪除多筆', en: 'Enter selection mode to delete multiple bookmarks' },
  ...
  'dock.bypass': { zh: '略過', en: 'Bypass' },
  'dock.auto_stop': { zh: '自動停止', en: 'Auto-stop' },
  'dock.reroute': { zh: '重新規劃', en: 'Reroute' },
  ...
  'dock.recenter': { zh: '回中', en: 'Recenter' },
  ...
  'bm.tag_new_placeholder': { zh: '新標籤名稱', en: 'New tag name' },
  'bm.tag_add_btn': { zh: '新增標籤', en: 'New tag' },
  ...
  'bm.tag_add_placeholder': { zh: '輸入新標籤名稱', en: 'Enter new tag name' },
  ...
  'device.add_via_usb_hint': { zh: '用傳輸線連接 iPhone。記得在裝置上點選「信任這台電腦」。', en: 'Connect your iPhone with a cable. Make sure you\'ve tapped Trust This Computer on the device.' },
