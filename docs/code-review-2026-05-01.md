...
> **v0.14.6 (2026-05-02) — first half** — released [v0.14.6](https://github.com/crazycat836/GPSController/releases/tag/v0.14.6). 3 commits from one focused agent (H). Structural refactor — no behavior, wire-format, or public-API changes.
...
> **v0.14.6 (2026-05-02) — second half** — released [v0.14.6](https://github.com/crazycat836/GPSController/releases/tag/v0.14.6). 10 commits across 3 worktree agents (J pre-kill + I' + J'). Pure structural refactor — no behavior, wire-format, or public-API changes.
...
**Score after v0.14.6**: **24 of 25 HIGH (96%)** + **21 of ~25 MEDIUM (~84%)** + **9 of 10 LOW (90%)** + 4-of-6 sub-credit on the god-component HIGH item (DevicesPopover + useDevice + BookmarksPanel + BottomDock) = **58 of ~60 review items resolved (~97%)**.
